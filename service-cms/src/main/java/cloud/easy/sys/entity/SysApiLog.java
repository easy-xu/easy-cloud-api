...
public class SysApiLog extends BaseEntity {
     ...
     * 请求流水号
     */
    @Length(max = 60, message = "请求流水号长度不能超过60")
     ...
     * 接口编码
     */
    @Length(max = 20, message = "接口编码长度不能超过20")
     ...
     * 业务编号
     */
    @Length(max = 20, message = "业务编号长度不能超过20")
    @ApiModelProperty("业务编号")
    private String businessNo;
    /**
     * 系统编号
     */
    @Length(max = 20, message = "系统编号长度不能超过20")
     ...
     * 结果描述
     */
    @Length(max = 65535, message = "结果描述长度不能超过65535")
