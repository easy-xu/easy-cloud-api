...
-- 测试问卷主表
-- ----------------------------
drop table if exists quna_config;
create table quna_config
(
...
(
    ...
    txt         varchar(200) not null comment '选项文本',
...
-- 测试问卷记录表
-- ----------------------------
drop table if exists quna_answer;
create table quna_answer
(
...
-- questionnaire
-- quna_config,quna_config_question,quna_config_option,quna_answer,quna_answer_question
